...
// Icons updated to accept an optional className prop for flexible styling
...
export const Cog6ToothIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 12a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5V3m0 18v-1.5M4.5 12H3m18 0h-1.5m-3.182-5.318l-1.06-1.06m-8.486 8.486l-1.06-1.06m11.606 0l1.06-1.06M6.343 6.343l1.06 1.06" />
  </svg>
);
...
export const DownloadIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M12 9.75l-3 3m0 0l3 3m-3-3h7.5M8.197 2.255A9.003 9.003 0 0121 11.25a9.006 9.006 0 01-1.935 5.56" />
...
export const ExcelIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125V5.625a1.125 1.125 0 011.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v12.75c0 .621-.504 1.125-1.125 1.125m-17.25 0V5.625m17.25 13.875V5.625M12 8.25v3.75m0 0l3-3m-3 3l-3-3m3 3h4.5M12 15.75h.008v.008H12v-.008z" />
  </svg>
);
